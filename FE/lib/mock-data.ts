...
export const MOCK_AGENTS: AgentViewModel[] = [
  ...
  },
  {
    ...
    tradingThesis: "Fade extreme moves back to the 20-day average on majors.",
    feePercent: 500n,
  ...
  },
  {
    ...
    tradingThesis: "Pair perp shorts against spot longs to harvest funding.",
    feePercent: 1500n,
  ...
  },
  {
    ...
    tradingThesis: "Provide two-sided liquidity on low-volatility pairs.",
    feePercent: 300n,
