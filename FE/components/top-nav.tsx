        ...
        {!mounted ? (
          ...
          <Button
            ...
            onClick={async () => {
              ...
              if (!connector) {
                alert(
                  "Wallet tidak ditemukan. Pastikan MetaMask atau dompet EIP-1193 terpasang.",
                );
                return;
              }
              try {
                ...
                // User rejected, popup closed, or wallet is locked. Swallow so
                // the dev overlay does not surface MetaMask's own throw.
